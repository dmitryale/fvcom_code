...
% ARROW  Draw a line with an arrowhead.!updated by !da 2016.03.25
...
ax = repmat(gca,narrows,1);% ax = o * gca;%!da
...
% 	oldaxlims(min(find(oldaxlims(:,1)==0)),:) = [curax reshape(axl',1,6)];%!da
